  ...
  return (
    <>
      ...
      >
        ...
        />
        <span className="absolute inset-0 m-auto flex size-12 items-center justify-center rounded-full bg-black bg-opacity-30 text-white transition-colors duration-500 group-hover:bg-opacity-50">
          <Camera size={24} />
        </span>
      </button>
      {imageToCrop && (
