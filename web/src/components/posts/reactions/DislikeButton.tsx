    ...
    onMutate: async () => {
      ...
      queryClient.setQueryData<PostData>(["post-data", post.id], (oldData?: PostData) => {
        ...
        return {
          ...oldData,
          dislikes: isDisliked ? [] : [{ userId: "optimistic" }],
          likes: isDisliked ? oldData.likes : [],
          _count: {
            ...oldData._count,
            dislikes: isDisliked ? oldData._count.dislikes - 1 : oldData._count.dislikes + 1,
            likes:
              !isDisliked && oldData.likes.length > 0
                ? oldData._count.likes - 1
                : oldData._count.likes,
          },
        };
      });
    },
